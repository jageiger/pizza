...
class ModifiersControllerTest < ActionController::TestCase
  ...
  test "should create modifier" do
    assert_difference('Modifier.count') do
      post :create, modifier: { alt_name: @modifier.alt_name, name: @modifier.name, price: @modifier.price, use_extras: @modifier.use_extras }
    end
  ...
  test "should update modifier" do
    patch :update, id: @modifier, modifier: { alt_name: @modifier.alt_name, name: @modifier.name, price: @modifier.price, use_extras: @modifier.use_extras }
    assert_redirected_to modifier_path(assigns(:modifier))
  end
